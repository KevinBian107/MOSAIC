...
This codebase is designed for developing SOTA methods in motif preserving graph generation. The codebase should bde designed to be highly structured, with flexiability of using multiple different dataset (both synthetic and real), multiple tokenization scheme, and different evaluation metric.
...
5. Place tests in corresponding module under `tests/`
