...
Generates molecules using a trained HDTC model and saves them as JSON with:
- SMILES, validity, atom count
- Community structure (type, atom indices, internal edges)
- Super-edges
...
def main():
    ...
    while len(all_molecules) < args.num_molecules:
        ...
        for tokens in results:
            demo_data = molecule_to_demo_data(tokens.cpu(), tokenizer, mol_idx)
